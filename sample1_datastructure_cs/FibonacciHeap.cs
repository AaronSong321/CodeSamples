...
{
    public class FibonacciHeap<TK>: IHeap<FibonacciNode<TK>>, IPriorityQueue<FibonacciNode<TK>>
        where TK:IComparable<TK>
    {
        ...
        */
        ...
        //a and b should never be used again
        ...
        public void Push(FibonacciNode<TK> node) => Insert(node);
        public void Pop()
        {
            ExtractMin();
        }
        public FibonacciNode<TK> Top() => Minimum();

        public void Enqueue(FibonacciNode<TK> node) => Insert(node);
        public void Dequeue() { ExtractMin(); }
        public FibonacciNode<TK> Peek() => Minimum();
    }
}
