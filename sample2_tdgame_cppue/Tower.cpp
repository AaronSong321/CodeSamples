...
void ATower::ChangeScope(float newScope) {
	Scope = newScope;
	SphereComp->SetSphereRadius(newScope);
}
...
void ATower::Shoot()
{
	...
	AddEnemyDebuffsToBullet(bullet);
}

void ATower::AddEnemyDebuffsToBullet(ABullet* bullet) {
